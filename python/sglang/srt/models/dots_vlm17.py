...
from sglang.srt.configs.dots_vlm import DotsVLM17Config
...
class DotsVLM17ForCausalLM(nn.Module):
    """DotsVLM model for sglang inference"""

    def __init__(
        self, config: DotsVLM17Config, quant_config: Optional[QuantizationConfig] = None
    ) -> None:
        super().__init__()
...
EntryClass = [DotsVLM17ForCausalLM]

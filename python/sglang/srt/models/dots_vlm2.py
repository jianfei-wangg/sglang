...
from sglang.srt.models.dots import DotsForCausalLM

from .dots_vlm_vit import DotsVisionTransformer


class DotsVLM2ForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        self.language_model = DotsForCausalLM(
    ...
    def get_model_config_for_expert_location(cls, config):
        return DotsForCausalLM.get_model_config_for_expert_location(config.language_config)
